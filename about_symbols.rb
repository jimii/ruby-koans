...
class AboutSymbols < Neo::Koan
  ...
  # response: we went to compare content, not objects
  ...
  # response: they are immutable, each uniq symbol will allocate memory
  # however: from ruby 2.2 symbols are automatically garbage collected
end
